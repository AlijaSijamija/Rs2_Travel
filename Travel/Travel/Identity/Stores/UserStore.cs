...
namespace Travel.Identity.Stores
{
    public class UserStore : IUserStore<User>, IUserEmailStore<User>, IUserPasswordStore<User>, IUserRoleStore<User>, IUserSecurityStampStore<User>
    {
        ...
        public Task SetEmailAsync(User user, string email, CancellationToken cancellationToken)
        {
            if (!EmailValidator.IsValidEmail(email))
                throw new ApiException("Mail address is not valid", System.Net.HttpStatusCode.BadRequest);
        ...
        public async Task AddToRoleAsync(User user, string roleName, CancellationToken cancellationToken)
        {
            ...
            {
                throw new ApiException($"User alread has role {roleName} assigned.", System.Net.HttpStatusCode.BadRequest);
            }
